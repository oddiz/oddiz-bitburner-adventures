export const TASK_EXEC_INTERVAL = 300; // times between hack-grow-weaken trio
...
export const COMMAND_EXEC_MIN_INTERVAL = 3000; // minimum time between commands
...
export const MONITORJS_REFRESH_INTERVAL = 1000 / 10; // 10 hz- how often to refresh the monitor
