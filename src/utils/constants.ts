export const TASK_EXEC_INTERVAL = 400; // times between hack-grow-weaken trio

export const COMMAND_EXEC_MIN_INTERVAL = 2000; // minimum time between commands
export const MAX_COMMAND_EXEC_LAG = 50; // if command is executed later than this, it will be skipped

export const ODDIZ_HACK_TOOLKIT_SCRIPT_NAME = "main.js";

export const ODDIZ_UI_ENCHANCEMENTS_PATH = "/ui/ui.js";

export const MINIMUM_RAM_TO_BUY = 64; // when buying remote servers, this is minimum ram to buy
